          ...
          <div className="row justify-content-center">
            ...
            <div className="col-md-12">
              <article>
                ...
                <p><strong>TLDR</strong>: I'm not tracking you. Just tracking my website traffic.</p>
                <h2 id="website-visitors">Website visitors</h2>
                <ul>
                  <li>No personal information is collected.</li>
                  <li>No personal information is stored in the browser.</li>
                  <li>No personal information is shared with advertising companies.</li>
                ...
                <p><a href="mailto:pawarprathamesh8655@gmail.com" className="connect">Contact me</a> if you have any questions.</p>
                <p>Effective Date: <em>19th Mar 2022</em></p>
